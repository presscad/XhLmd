...
// Attributes
public:
    void SetTextColor(COLORREF crTextColour= -1);
	COLORREF GetTextColor() const{	return m_crTextColor; }
	void SetBackgroundColour(COLORREF crBackground);
	COLORREF GetBackgroundColour() const{	return m_crBackground;	}
...
public:
	...
	void EnableHover(BOOL bFlag){m_bHoverEnabled=bFlag;}
	BOOL IsEnabledHover(){return m_bHoverEnabled;}
	...
	HCURSOR CLinkLabel::GetLinkCursor() const
	{
