...
enum XHPRODUCT_TYPE{PRODUCT_TMA=1,PRODUCT_LMA,PRODUCT_TSA,PRODUCT_LDS,PRODUCT_TDA,PRODUCT_CTMA,
	PRODUCT_PAILIAO,PRODUCT_PMS,PRODUCT_MRP,PRODUCT_TAP,PRODUCT_TMS,PRODUCT_PNC,PRODUCT_IBOM,PRODUCT_TMDH,PRODUCT_CNC};
